...
//   return (
//     <section className="relative w-full overflow-hidden">
//       <div className="relative w-full z-10 p-3 md:p-5 lg:p-8" style={{ color: "#FFFFFF" }}>
//         {/* ---- Heading Section ---- */}
//         <div className="text-center md:text-right mb-8 p-5 relative z-2">
//           {/* First Line */}
//           <h1 className="text-xl lg:-ml-29 sm:text-3xl md:text-[90px] mb-3 md:mb-20 flex items-center justify-center md:justify-end gap-3 pl-0 mr-0 md:mr-25">
//             <span
//               style={{
//                 color: "#418CFF",
//                 fontWeight: 5,
...
//               style={{ color: "#060832", fontFamily: "Plus Jakarta Sans" }}
//             >
//               The
//             </span>{" "}
//             <span
//               className="tracking-tight lg:ml-10 md:text-[140px] lg:text-[190px]"
//               style={{ fontWeight: "500", fontFamily: "Plus Jakarta Sans" }}
//             >
//               Ai Summit
//             </span>
//           </h1>
...
//         <div className="p-3 -mt-10" style={{ backgroundColor: "white" }}>
//           <div
//             className="relative w-full z-10 px-1"
//             style={{ color: "#FFFFFF" }}
//           >
//             <div className="mt-20 md:!mt-[-80px] overflow-visible w-full rounded-3xl md:rounded-4xl flex flex-col justify-between relative leading-normal md:leading-relaxed min-h-[550px] p-10 md:p-10">
//               {/* Background Video */}
...
//                 <div>
//                   <div
//                     className="mx-auto md:ml-0 w-full md:w-1/2 lg:[600px] lg:mt-0 p-4 lg:p-3 md:p-6 rounded-4xl shadow-sm"
//                     style={{
...
//                       ScaleUp <br className="block md:hidden" /> Conclave{" "}
//                       <span
//                         className="font-gilmer  decoration-[3px]"
//                         style={{ textDecorationColor: "#9CF694" }}
//                       >
//                         2026
//                       </span>{" "}
//                       <br /> is back and this <br className="block md:hidden" />{" "}
//                       time,{" "}
//                       <span
//                         className="font-gilmer decoration-[3px]"
//                         style={{ textDecorationColor: "#9CF694" }}
...
//                 {/* Bottom Section */}
//                 <div
//                   className="mt-8 md:mt-5 lg:mt-20 flex flex-col items-start"
//                   style={{ color: "#FFFFFF" }}
//                 >
//                   {/* Arrow */}
//                   <img
...
//                   <div className="flex flex-col md:flex-row items-start md:items-center justify-between w-full gap-4">
//                     <h2
//                       className="font-gilmer text-2xl sm:text-4xl md:text-7xl  mt-4 lg:mt-8 md:mt-0 text-left"
...
//                     <div
//                       className="flex flex-col md:flex-row items-center gap-3 mt-6 md:mt-0"
//                       style={{ fontFamily: "Plus Jakarta Sans" }}
//                     >
//                       <button className="font-gilmer flex items-center gap-2 px-4 py-3 rounded-2xl h-[50px] backdrop-blur-md border border-white/20 transition duration-300 hover:bg-white/20">
//                         <img
