...
//   return (
//     <section className="mx-auto max-w-full  py-16 px-16 md:px-26 sm:px-6 lg:px-8">
//       <style jsx>{`
...
function Involved() {
  ...
  return (
    ...
    <section className="relative w-full  py-16 px-6 md:px-16 max-w-full mx-auto" style={{fontFamily:"Plus Jakarta Sans"}}>
      {/* <style jsx>{`
        .scroll-container::-webkit-scrollbar {
          display: none;
        }
