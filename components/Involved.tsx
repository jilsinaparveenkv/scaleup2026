...
function Involved() {
  ...
  return (
    // 🔹 MATCHED WIDTH WITH ScaleUpSection
    <section className="relative w-full py-4 md:py-16 px-4 md:px-16 max-w-full mx-auto" style={{fontFamily:"Plus Jakarta Sans"}}>
      {/* <style jsx>{`
      ...
      {/* Header */}
      <div
        className="flex items-start justify-between mb-8 md:mb-12"
        style={{ fontFamily: "Plus Jakarta Sans" }}
      >
        <div className="flex-1">
          <h2
            className={`font-semibold leading-[63.41px] tracking-[0px]`}
            style={{
          ...
          <p
            className="mt-2 mb-0 md:mt-4 font-light"
            style={{
            ...
            return (
              ...
              >
                <div>
                  ...
                  <h3 className="mt-8 text-2xl font-bold" style={{fontFamily:"Plus Jakarta Sans"}}>{card.title}</h3>
                  <p className="mt-3" style={{fontFamily:"Plus Jakarta Sans"}}>{card.description}</p>
                </div>
                ...
                >
                  <span className="mr-6" style={{fontFamily:"Plus Jakarta Sans"}}>Apply Now</span>
              ...
              return (
                ...
                >
                  <div>
                    ...
                    <h3 className="mt-6 text-lg font-bold" style={{fontFamily:"Plus Jakarta Sans"}}>{card.title}</h3>
                    <p className="mt-2 text-base" style={{fontFamily:"Plus Jakarta Sans"}}>{card.description}</p>
                  </div>
                  ...
                  <a
                    ...
                    className="mt-4 flex items-center justify-end font-semibold no-underline"
                  >
                    <span className="mr-4 text-base" style={{fontFamily:"Plus Jakarta Sans"}}>Apply Now</span>
                    <img src={arrow} alt="Arrow icon" className="h-6 w-10" />
                  </a>
                </div>
              );
            })}
...
//   return (
//     <section
//       className="relative w-full py-16 px-6 md:px-16 max-w-full mx-auto"
//       style={{ fontFamily: "Plus Jakarta Sans" }}
//     >
//       {/* Header */}
...
//             className="font-semibold leading-[63.41px] tracking-[0px]"
//             style={{
//               fontSize: device === "mobile" ? "40px" : "57.21px",
//               color: "#202020",
//               fontFamily: "Plus Jakarta Sans",
//             }}
//           >
...
//             style={{
//               fontSize: device === "mobile" ? "18px" : "28px",
//               lineHeight: device === "mobile" ? "22px" : "36px",
//               color: "#202020",
//               fontFamily: "Plus Jakarta Sans",
//             }}
//           >
...
//                       className="h-12 w-12 rounded-lg flex items-center justify-center"
//                       style={{
//                         backgroundColor: active ? "#9CF694" : "#2E96F5",
//                       }}
//                     ></div>
//                     <img
//                       src={card.icon}
...
//                     {card.title}
//                   </h3>
//                   <p className="mt-3" style={{ fontFamily: "Plus Jakarta Sans" }}>
//                     {card.description}
//                   </p>
//                 </div>
...
//                 onMouseEnter={() => setHoveredCard(card.id)}
//                 onMouseLeave={() => setHoveredCard(null)}
//                 className="flex flex-col justify-between rounded-3xl border p-6 shadow-sm transition hover:shadow-md cursor-pointer"
//                 style={{
//                   borderColor: "#000",
//                   backgroundColor: active ? "#1E90FF" : "#FFFFFF",
//                   color: active ? "#FFFFFF" : "#202020",
...
//                     {card.title}
//                   </h3>
//                   <p className="mt-2 text-lg" style={{ fontFamily: "Plus Jakarta Sans" }}>
//                     {card.description}
//                   </p>
//                 </div>
...
//                   rel="noopener noreferrer"
//                   className="mt-4 flex items-center justify-end font-semibold no-underline"
//                   style={{ color: active ? "#FFFFFF" : "black" }}
//                 >
//                   <span className="mr-4" style={{ fontFamily: "Plus Jakarta Sans" }}>
//                     Apply Now
//                   </span>
...
//           <div
//             className="flex overflow-x-auto space-x-4 pb-6 snap-x snap-mandatory scroll-smooth scrollbar-hide"
...
//                       <div
//                         className={`h-10 w-10 rounded-lg flex items-center justify-center ${
//                           active ? "bg-green-300" : "bg-blue-500"
//                         }`}
//                       ></div>
//                       <img
//                         src={card.icon}
...
//       {/* ---------- Tablet View (Swipe like Mobile) ---------- */}
//       {device === "tablet" && (
//         <div className="w-full max-w-[600px] mx-auto overflow-hidden px-0">
//           <div
...
//                   onMouseEnter={() => setHoveredCard(card.id)}
//                   onMouseLeave={() => setHoveredCard(null)}
//                   className={`snap-start flex-shrink-0 w-[70%] sm:w-[350px] flex flex-col justify-between rounded-3xl border p-8 shadow-sm transition-all duration-300 ${
//                     active ? "bg-blue-600 text-white" : "bg-white text-gray-900"
//                   }`}
//                   style={{
//                     borderColor: "#000",
...
// function Involved() {
//   const [isCompactView, setIsCompactView] = useState(false); // mobile + tablet
//   const [hoveredCard, setHoveredCard] = useState<number | null>(null);

//   useEffect(() => {
//     const handleResize = () => {
//       const compact = window.innerWidth <= 1024; // tablet & mobile
...
//     >
//       {/* Header */}
//       <div className="flex items-start justify-between mb-12 max-w-[800px] mx-auto">
//         <div className="flex-1">
//           <h2
//             className="font-semibold leading-[63.41px] tracking-[0px]"
//             style={{
//               fontSize: isCompactView ? "40px" : "57.21px",
//               color: "#202020",
//             }}
//           >
//             Get Involved
...
//             className="mt-4 font-light"
//             style={{
//               fontSize: isCompactView ? "18px" : "28px",
//               lineHeight: isCompactView ? "22px" : "36px",
//               color: "#202020",
//             }}
//           >
//             Be part of Kerala&apos;s biggest AI & Technology Conclave and connect with
...
//       {/* ---------------- Desktop View ---------------- */}
//       {!isCompactView && (
//         <div className="max-w-[1100px] mx-auto grid grid-cols-1 gap-8 sm:grid-cols-2 lg:grid-cols-4">
//           {cards.map((card) => {
//             const isActiveOrHovered = hoveredCard === card.id;
//             const arrow = isActiveOrHovered
//               ? "/assets/images/arrow_icon_green.svg"
...
//           <div
//             className="scroll-container flex overflow-x-auto space-x-6 pb-6 snap-x snap-mandatory scroll-smooth scrollbar-hide"
//             style={{ WebkitOverflowScrolling: "touch" }}
//           >
//             {cards.map((card) => {
//               const isHovered = hoveredCard === card.id;
...
//                   onTouchStart={() => setHoveredCard(card.id)}
//                   onTouchEnd={() => setHoveredCard(null)}
//                   className={`snap-start flex-shrink-0 w-[75%] sm:w-[320px] md:w-[350px] flex flex-col justify-between rounded-3xl border p-6 shadow-sm transition-all duration-300 ${
//                     isHovered
